...
- Een draaiende Nextcloud met OpenRegister geïnstalleerd. Heb je dat nog niet, volg dan eerst [Nextcloud lokaal draaien met Docker](/academy/nextcloud-lokaal-draaien)
