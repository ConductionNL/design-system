...
- Een werkende Nextcloud op `http://localhost:8080`
- Postgres voor data, Redis voor cache, Nextcloud voor het werk
- Een admin-account waar je naar believen apps op installeert
- Eén `docker compose down -v` om alles weer op te ruimen
...
- Een laptop met minimaal 4 GB vrij geheugen
- Docker, lokaal draaiend
