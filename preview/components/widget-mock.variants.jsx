...
const ITEMS = [
  { num: '01', label: 'Filinq · Anonymise drop',         tag: 'INFERRED', kind: 'docudesk-anonymise',
    desc: 'Drop a document into the tile, get back a redacted copy. Action-first widget; no status pip, no list, just the drop-zone.' },
  { num: '02', label: 'Filinq · Pending signatures',     tag: 'INFERRED', kind: 'docudesk-pending-sign',
  ...
  { num: '03', label: 'Dossiq · Werkvoorraad',            tag: 'INFERRED', kind: 'procest-werkvoorraad',
  ...
  { num: '04', label: 'Dossiq · Due today',               tag: 'INFERRED', kind: 'procest-due-today',
  ...
  { num: '07', label: 'Integriq · Recent runs',       tag: 'INFERRED', kind: 'openconnector-runs',
