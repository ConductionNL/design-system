...
const ICONS = {
  ...
  /* The two fediverse marks are trademarks, not icons we may draw, so
     ...
     They are the only two icons here that must not take the
     brand colour. Bluesky permits the butterfly as a profile link with
     no permission needed (Trademark Policy 4.1) but forbids recolouring
     outside the black and white variants; Mastodon's policy says not to
     change or modify the marks at all. So these two render black on the
     light chip and white on the cobalt hover chip — the two variants
     both brands sanction — instead of inheriting currentColor.
